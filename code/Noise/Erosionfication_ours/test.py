...
parser.add_argument('--save_folder_train', default='/cmlscratch/hmchu/diff/', type=str)
parser.add_argument('--save_folder_test', default='/cmlscratch/hmchu/diff_paper_test/', type=str)
...
parser.add_argument('--dataset_folder', default='./root_ARMCD', type=str)
