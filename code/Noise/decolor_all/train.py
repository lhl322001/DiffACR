...
parser.add_argument('--save_folder', default='/cmlscratch/hmchu/ero_diff/', type=str)
parser.add_argument('--load_path', default=None, type=str)
parser.add_argument('--train_routine', default='Final', type=str)
parser.add_argument('--sampling_routine', default='x0_step_down', type=str)
parser.add_argument('--remove_time_embed', action="store_true")
parser.add_argument('--dataset_folder', default='./ARMCD', type=str)
...
if 'ARMCD' in args.dataset:
    use_torchvison_dataset = True
    args.dataset = 'ARMCD_train'
